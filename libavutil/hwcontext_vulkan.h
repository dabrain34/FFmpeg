...
/**
 * For a given pixel format, returns the VkFormat to use, the number of images
 * to use, the pixfmt which encompasses all planes, and the supported usage.
 */
int av_vkfmt_from_pixfmt2(AVHWDeviceContext *dev_ctx, enum AVPixelFormat p,
